...
UTEST(set_bits, value_FF_offset_8_size_8)
{
   ...
   set_bits(buffer, 8, 0b11111111, 8);

   ASSERT_EQ(buffer[0], 0b00000000);
   ASSERT_EQ(buffer[1], 0b11111111);
   ASSERT_EQ(buffer[2], 0b00000000);
...
UTEST(set_bits, value_FF_offset_11_size_8)
{
   // 00000000 00000000 00000000 00000000 00000000
   uint8_t buffer[5] = { 0x00 };

   // 00000000 11111000 00000111 00000000 00000000
   set_bits(buffer, 11, 0b11111111, 8);

   ASSERT_EQ(buffer[0], 0b00000000);
   ASSERT_EQ(buffer[1], 0b11111000);
   ASSERT_EQ(buffer[2], 0b00000111);
   ASSERT_EQ(buffer[3], 0b00000000);
   ASSERT_EQ(buffer[4], 0b00000000);
}

UTEST(set_bits, value_FF_offset_12_size_8)
{
   // 00000000 00000000 00000000 00000000 00000000
   uint8_t buffer[5] = { 0x00 };

   // 00000000 11111000 00000111 00000000 00000000
   set_bits(buffer, 12, 0b11111111, 8);

   ASSERT_EQ(buffer[0], 0b00000000);
   ASSERT_EQ(buffer[1], 0b11110000);
   ASSERT_EQ(buffer[2], 0b00001111);
   ASSERT_EQ(buffer[3], 0b00000000);
   ASSERT_EQ(buffer[4], 0b00000000);
}

UTEST(set_bits, value_1FF_offset_8_size_8)
{
   // 00000000 00000000 00000000 00000000 00000000
   uint8_t buffer[5] = { 0x00 };

   // 00000000 11111111 00000001 00000000 00000000
   set_bits(buffer, 8, 0b111111111, 9);
